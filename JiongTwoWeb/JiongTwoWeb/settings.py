"""
Django settings for JiongTwoWeb project.
...
SECRET_KEY = 'm-wk8ba)ejv=43eu+q^wjlfl$zs$l1zb55iuu#sv@^6hamr7c0'
...
MIDDLEWARE = [
    ...
    # 'django.middleware.locale.LocaleMiddleware',  # 国际化翻译添加此行
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                # 'django.template.context_processors.i18n',  # 国际化要添加此行
...
WSGI_APPLICATION = 'JiongTwoWeb.wsgi.application'
...
AUTH_USER_MODEL = 'home.JtUserProfile'
...
SIMPLEUI_CONFIG = {
    ...
    'menu_display': ['系统', '信息管理', '留言管理', '招聘管理', '管理员管理', ],
    'menus': [
        {
            'name': '系统',
            'icon': 'fas fa-cog',
